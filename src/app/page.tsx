...
// import { useHomeStatistics, usePetCareContent ,useHomeContentByCategories } from "./api/useHomeApi";
...
//   const { data:homeContent, isLoading:loading } = useHomeContentByCategories(categoriesWithSubcategories);
...
//           <Heading>Discover dog and cat breed guides, essential pet health tips, nutrition advice, and more — all in one place.</Heading>
